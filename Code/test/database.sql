...
insert into "Restaurant" values (1, 1, 'Pancake House', 'info1');
insert into "Restaurant" values (2, 1, 'Garden Cafe', 'info2');
insert into "Restaurant" values (3, 1, 'Feria', 'info3');
insert into "Restaurant" values (4, 1, 'Cafe Marco', 'info4');
insert into "Restaurant" values (5, 1, 'Anzani', 'info5');
insert into "Restaurant" values (6, 2, 'Greenwich', 'info6');
insert into "Restaurant" values (7, 2, 'Vikings', 'info7');
insert into "Restaurant" values (8, 2, 'Sambo Kojin', 'info8');
insert into "Restaurant" values (9, 3, 'High Ridge', 'info9');
insert into "Restaurant" values (10, 3, 'Misto', 'info10');
insert into "Restaurant" values (11, 3, 'Grand Caprice', 'info11');
insert into "Restaurant" values (12, 3, 'Yellow Cab Pizza', 'info12');
insert into "Restaurant" values (13, 4, 'Pizzarella', 'info13');
insert into "Restaurant" values (14, 4, 'Jollibee', 'info14');
insert into "Restaurant" values (15, 4, 'Mcdo', 'info15');
insert into "Restaurant" values (16, 4, 'Lai-Lai Yeoung Chow', 'info16');
insert into "Restaurant" values (17, 5, 'Omakase', 'info17');
insert into "Restaurant" values (18, 5, 'Lazy Bastard', 'info18');
insert into "Restaurant" values (19, 5, 'Yardstick', 'info19');
insert into "Restaurant" values (20, 5, 'Sweet Ecstasy', 'info20');
